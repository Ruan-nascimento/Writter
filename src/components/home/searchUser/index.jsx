...
export function FindUser() {
  ...
  return(
    <section className="flex no-scrollbar flex-col items-center justify-start gap-3 flex-1 max-full max-h-5pc h-4pc py-4 px-2 overflow-auto bg-gray-800 rounded-md">
